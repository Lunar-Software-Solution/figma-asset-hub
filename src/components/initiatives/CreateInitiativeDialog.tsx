...
interface CreateInitiativeDialogProps {
  ...
  onSubmit: (data: InitiativeFormValues) => Promise<void>;
}
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Q1 2026 Market Expansion" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      placeholder="Key steps to achieve this initiative..."
                      className="resize-none"
                      rows={3}
                      {...field} 
                    />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      placeholder="Budget, people, tools required..."
                      className="resize-none"
                      rows={2}
                      {...field} 
                    />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Risks & Mitigation</FormLabel>
                  <FormControl>
                    <Textarea 
                      placeholder="Potential obstacles and contingencies..."
                      className="resize-none"
                      rows={2}
                      {...field} 
                    />
